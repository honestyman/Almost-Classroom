<div class="p-8 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-300">
    <div>
        <form action="{{ route('post.comment.update', [$comment->post->id, $comment->id]) }}" method="POST">
            ...
            <span class="text-xl font-bold">Upravte komentář!</span>
            ...
            <div class="my-3">
                ...
                <x-text-input id="content"
                    ...
                    type="text" name="content" :value="old('content', isset($comment) ? $comment->content : '')" required autofocus autocomplete="content" />
